...
/* =========================
   Enhanced monochrome icons
   (inherit currentColor)
   ========================= */

function IconPlayMelody(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      <path
        fill="currentColor"
        d="M385.1,254.3l-86.3-49.8v71.6c0,3.6-0.6,7.3-1.8,11c-1.1,3.6-2.9,7.2-5.3,10.7c-6.6,9.8-17.1,17.5-29.5,21.8
        ...
        C394.8,273.8,394.8,259.9,385.1,254.3z"
      />
      <path
        fill="currentColor"
        d="M256,41C137.3,41,41,137.3,41,256s96.3,215,215,215s215-96.3,215-215S374.7,41,256,41z M256,435
        c-98.9,0-179-80.2-179-179S157.1,77,256,77s179,80.2,179,179S354.9,435,256,435z"
      />
      <path
        fill="currentColor"
        d="M220.5,265.5c-9,8.7-13.1,19.9-9.6,29.9c5.4,15.5,26.9,22.1,48.1,14.8c10.7-3.7,19.3-10.3,24.5-17.9
        ...
        C232,256.6,225.5,260.6,220.5,265.5z"
      />
    </svg>
  );
}

function IconPlayRhythm(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      <path
        fill="currentColor"
        d="M256,86.4c-83.6,0-151.7,68-151.7,151.7v160.8h36.6V238.1c0-63.5,51.6-115.1,115.1-115.1
        c63.5,0,115.1,51.6,115.1,115.1v160.8h36.6V238.1C407.7,154.5,339.6,86.4,256,86.4z"
      />
      <path
        fill="currentColor"
        d="M41.9,336.3c0,31.1,22.7,56.9,52.4,61.8V274.4c-13.2,2.2-25,8.5-34,17.5C48.9,303.3,41.9,318.9,41.9,336.3z"
      />
      <path
        fill="currentColor"
        d="M451.7,291.9c-9.1-9-20.9-15.4-34.1-17.5v123.7c29.7-4.9,52.4-30.7,52.4-61.8
        C470.1,318.9,463.1,303.3,451.7,291.9z"
      />
      <path
        fill="currentColor"
        d="M256.9,247.9c-49.1,0-88.8,39.8-88.8,88.8c0,49.1,39.8,88.8,88.8,88.8s88.8-39.8,88.8-88.8
        ...
        C328.3,352.7,328.3,355.8,326.4,357.8z"
      />
    </svg>
  );
}

function IconPlayBoth(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      <path
        fill="currentColor"
        d="M465.7,195.1V237l-58,6.3v168.3c0,7.6-2.7,15.3-7.4,22.3c-7.1,10.5-19,19.7-33.9,24.8
        c-29.3,10.2-59.1,1-66.6-20.4c-7.5-21.5,10.3-47.1,39.6-57.3c9.1-3.2,18.2-4.5,26.7-4.1V205.9l41.6-4.5L465.7,195.1z"
      />
      <path
        fill="currentColor"
        d="M325.9,49.1v214.1c0,7.6-2.7,15.3-7.4,22.3c-7.1,10.6-19,19.7-33.9,24.8c-29.3,10.2-59.1,1-66.6-20.4
        ...
        l128.4-13.9L325.9,49.1z"
      />
      <circle fill="currentColor" cx="178.3" cy="353.1" r="18.9" />
      <circle fill="currentColor" cx="269.9" cy="362.4" r="12.1" />
      <circle fill="currentColor" cx="442.7" cy="66.1" r="12.1" />
      <circle fill="currentColor" cx="221.5" cy="425.3" r="28.3" />
      <circle fill="currentColor" cx="389.6" cy="126.8" r="28.3" />
    </svg>
  );
}
