...
export const PremiumIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M106.5,219.8c0-2.8-2.2-5-5-5c-23.4,0-42.4-19-42.4-42.4s19-42.4,42.4-42.4c2.8,0,5-2.2,5-5s-2.2-5-5-5 c-28.9,0-52.4,23.5-52.4,52.4s23.5,52.4,52.4,52.4C104.3,224.8,106.5,222.5,106.5,219.8z" fill={PREMIUM_ST1}/>
