...
// IMPORTANT: Use an explicit element type instead of `satisfies` here.
// That avoids a union of literal element types where some don't have `soon`.
const ITEMS: readonly CurriculumItem[] = [
