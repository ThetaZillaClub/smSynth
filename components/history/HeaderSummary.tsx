          ...
          <div
            ...
            style={{
              ...
              ...(on
                ...
                : {
                    // OFF: solid fill, no background shorthand used
...
export default function HeaderSummary({
  ...
  timeOnPitchPct, // retained for future tooltips if needed
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  pitchMae, // ^
  melodyPct,
  linePct,
  intervalsPct,
  /** NEW: control visibility so we can hide summary cards when their detail tables have no rows */
  showPitch = true,
  showMelody = true,
  showLine = true,
  showIntervals = true,
