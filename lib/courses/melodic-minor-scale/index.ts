...
export default defineCourse({
  slug: "melodic-minor-scale-exercises",
  title: "Melodic Minor",
  subtitle: "Focused randomized practice for timing and reading in melodic minor.",
  base: BASE,
  lessons: [
    ...
    { slug: "quarter-eighth", title: "Quarters + Eighths", summary: "Subdivision stability in melodic minor.", overrides: { rhythm: { available: ["quarter", "eighth"] as NoteValue[] } } },
