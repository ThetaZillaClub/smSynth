...
const BASE: Partial<SessionConfig> = {
  ...
  // Natural minor scale — no degree limitation
...
export default defineCourse({
  ...
  subtitle:
    "Build timing and full-range fluency in natural minor with randomized exercises—develop confident reading and navigation across the minor scale.",
  base: BASE,
  lessons: [
    {
      slug: "quarters-only",
      title: "Quarters Only",
      summary: "Quarter-note prompts over the full natural minor scale; natural rests included.",
      overrides: {
    ...
    },
    {
      ...
      summary: "Mix of quarters and eighths to strengthen groove and subdivision in minor.",
      overrides: {
